    ...
    if (response.statusCode == 200) {
      ...
      if (data.isNotEmpty) {
        ...
        if (startPoint != null && endPoint != null) {
          mapController.addMarker(startPoint!, markerIcon: MarkerIcon(icon: Icon(Icons.location_pin, color: Colors.green, size: 48)));
          mapController.addMarker(endPoint!, markerIcon: MarkerIcon(icon: Icon(Icons.location_pin, color: Colors.red, size: 48)));
          mapController.setZoom(zoomLevel: 12);
          mapController.goToLocation(
              GeoPoint(latitude: (startPoint!.latitude + endPoint!.latitude) / 2, longitude: (startPoint!.longitude + endPoint!.longitude) / 2));
        }
      }
    }
  }
...
//                   decoration: InputDecoration(
//                     prefixIcon: Icon(Icons.circle, color: Colors.black, size: 15.0),
//                     hintText: '1234 University Street',
//                     border: OutlineInputBorder(
//                       borderRadius: BorderRadius.circular(8.0),
//                     ),
//                     filled: true,
